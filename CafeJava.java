public class CafeJava {
    public static void main(String[] args) {
        ...
        System.out.println(generalGreeting + customer1 + (isReadyOrder1? readyMessage + customer1 : pendingMessage)); // Displays "Your order is ready cindhuri" or "Your order will be ready shortly cindhuri"
        ...
        System.out.println(generalGreeting + customer4 + ( isReadyOrder4? readyMessage +','+ displayTotalMessage + cappuccinoPrice : pendingMessage)); 
//Sam just ordered 2 lattes, print the message to display their total. Next, use an if statement to print the appropriate order status message. Change the isReady flag value from true to false or vice versa in order to test your control logic (if-statement).
        System.out.println( generalGreeting + customer2 + (isReadyOrder2? readyMessage +','+ displayTotalMessage + lattePrice * 2 : pendingMessage));
        ...
        System.out.println(generalGreeting + customer3 + (isReadyOrder3? readyMessage +','+ displayTotalMessage + (lattePrice-mochaPrice) : pendingMessage));
